...
#   1) take a random integer between 3 and 2000
#      and calculate all primes up to that limit
#      (lower limit 3: to always have at least one prime number, otherwise
#      the code for computing the average becomes a little more complicated.)
...
for i in range(1, 30000):
	# We take a random integer between 3 and 2000
	top = random.randrange(3,2000)
