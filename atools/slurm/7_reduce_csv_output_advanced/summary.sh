...
arange -t 1-100 --log logdemo.slurm.log* --long_summary
...
arange -t 1-100 --log logdemo.slurm.log* --completed

printf "\n\e[0;34mAggregating results of all completed jobs in a .csv file:\e[0m\n\n"
areduce -t $(arange -t 1-100 --log logdemo.slurm.log* --completed) --pattern 'output-{t}.csv' --out output-agr.csv --mode csv
cat output-agr.csv
...
areduce -t $(arange -t 1-100 --log logdemo.slurm.log* --completed) --pattern 'output-{t}.csv' \
