...
areduce -t $(arange -t 1-100 --log logdemo.slurm.log* --list_completed) --pattern 'output-{t}.csv' --mode body --reduce_args '--h 1' --out output-agr-body.csv
