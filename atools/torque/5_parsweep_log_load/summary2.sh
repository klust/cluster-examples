...
arange --data datalog.csv --log weatherlog1.pbs.log* weatherlog2.pbs.log* --summary --list_completed --list_failed --list_todo
...
aload --log weatherlog2.pbs.log* --list_slaves
